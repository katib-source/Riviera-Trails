...
const ClientMemoriesPage = () => {
  ...
  const extendedTestimonials = [
    ...testimonials,
    {
      ...
      country: "France",
      rating: 5,
      text: "Even as a local, I discovered hidden gems I never knew existed. The team's passion for the region is absolutely contagious!",
      image:
    ...
    },
    {
      ...
      country: "Singapore",
      rating: 5,
      text: "Perfect honeymoon experience! The small group setting made it intimate and our guide captured beautiful photos of us throughout the day.",
      image:
    ...
    },
    {
      ...
      country: "Spain",
      rating: 5,
      text: "Traveling with our teenagers can be challenging, but Azur Escape made it magical for all of us. The guides were patient and knowledgeable.",
      image:
    ...
    },
    {
      ...
      country: "Australia",
      rating: 5,
      text: "At 72, I wasn't sure about doing tours anymore, but Azur Escape made everything so comfortable and accessible.",
      image:
    ...
    },
    {
      ...
      country: "UAE",
      rating: 5,
      text: "As first-time visitors to France, we were nervous about the language barrier. The multilingual guides made us feel so welcome.",
      image:
    ...
    },
    {
      ...
      country: "Ireland",
      rating: 5,
      text: "Two mates on a lads' trip and we had the absolute best time! The guides were brilliant and showed us the best spots.",
      image:
    ...
    },
    {
      ...
      country: "Japan",
      rating: 5,
      text: "We were worried about the language barrier, but the guides were so patient and understanding. We learned so much!",
      image:
    ...
    },
    {
      ...
      country: "Mexico",
      rating: 5,
      text: "¡Increíble! The tour exceeded all our expectations. The guides spoke Spanish and made us feel like family.",
      image:
  ...
  const filteredTestimonials =
    filter === "all"
      ...
      : extendedTestimonials.filter((t) =>
          t.tour?.toLowerCase().includes(filter.toLowerCase())
        );
  ...
  const masonryImages = filteredTestimonials.map((testimonial, index) => {
    ...
    return {
      ...
      onClick: () => {
        setActiveTestimonial(
          filteredTestimonials.findIndex((t) => t.id === testimonial.id)
        );
        setIsAutoPlaying(false);
      },
      className: `rc-w-${width} rc-h-${height} cursor-pointer hover:scale-105 transition-transform duration-300 rounded-lg shadow-md hover:shadow-xl relative overflow-hidden`,
    };
  });
  ...
  const currentTestimonial =
    filteredTestimonials[activeTestimonial] || filteredTestimonials[0];
  ...
  const tourFilters = [
    ...
    { value: "monaco", label: "Monaco Tours" },
    { value: "cannes", label: "Cannes Tours" },
    { value: "eze", label: "Eze Tours" },
    ...
    <div className="min-h-screen bg-white pt-20">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                    filter === filterOption.value
                      ? "bg-riviera-blue text-white shadow-lg scale-105"
                ...
                <div className="relative bg-gray-800 rounded-2xl p-4 h-[500px] overflow-hidden">
                  {filteredTestimonials.length > 0 ? (
                    ...
                    <div className="flex items-center justify-center h-full text-gray-400">
                      <div className="text-center">
                        <FiFilter className="w-16 h-16 mx-auto mb-4 opacity-50" />
              ...
              <div className="lg:w-2/5 space-y-6">
                {currentTestimonial && (
                  <>
                    ...
                    <div
                      className={`bg-gradient-to-br ${currentTestimonial.bgColor} rounded-3xl p-8 shadow-xl transform transition-all duration-500 border-2 ${currentTestimonial.borderColor}`}
                    >
                          ...
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              <span className="text-lg">
                                {getCountryFlag(currentTestimonial.country)}
                              </span>
                              <FiMapPin
                    ...
                    <div className="space-y-3">
                      {filteredTestimonials
                        ...
                        .map((testimonial, index) => (
                          <div
                            key={testimonial.id}
                            className={`bg-gradient-to-r ${testimonial.bgColor} rounded-2xl p-4 cursor-pointer hover:shadow-lg transition-all duration-300 opacity-80 hover:opacity-100 border ${testimonial.borderColor}`}
                            onClick={() => {
                              const realIndex = filteredTestimonials.findIndex(
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          ...
          <span className="hidden sm:block font-semibold">Book Your Tour</span>
        </a>
      </div>
    </div>
  );
...
export default ClientMemoriesPage;
