...
export const toursData = {
  ...
  fr: [
    ...
    },
    {
      ...
      description:
        "Explorez les secrets des parfums de Grasse, les villages médiévaux et les vues côtières époustouflantes.",
      price: "€115",
      priceType: "par personne*",
      image:
        "https://cdn.pixabay.com/photo/2014/11/16/12/33/gordes-533375_1280.jpg",
    ...
    },
    {
      ...
      description:
        "Découvrez les champs de lavande, les cascades et le lac rafraîchissant de Saint-Cassien.",
      price: "€119",
      priceType: "par personne*",
      image:
        "https://www.paysdefayence.com/wp-content/uploads/2024/06/panorama-saintcassien-otipf_jeanpaulvillegas-2.jpg",
    ...
    },
    {
      ...
      title: "Cannes • Antibes • St-Paul de Vence",
      description:
        "Route côtière de Cannes à Antibes, se terminant au joyau médiéval Saint-Paul-de-Vence.",
      price: "€85",
      priceType: "par personne*",
      image:
        "https://cdn.pixabay.com/photo/2018/04/06/10/05/travel-3295399_1280.jpg",
    ...
    },
    {
      ...
      title: "Eze • Monaco • Monte-Carlo",
      description:
        "Visitez l'usine de parfum d'Eze, le palais de Monaco et les lieux de luxe de Monte-Carlo.",
      price: "€85",
      priceType: "par personne*",
      image:
        "https://cdn.pixabay.com/photo/2018/07/13/21/04/the-french-riviera-3536553_1280.jpg",
      duration: "Demi-journée (4h30)",
      city: "Village d'Eze, Monaco, Monte-Carlo",
      topPick: true,
      departure: "9h00 ou 14h00",
      highlights: ["Village d'Eze", "Monaco", "Monte-Carlo"],
      shared: true,
    },
  ],
};
