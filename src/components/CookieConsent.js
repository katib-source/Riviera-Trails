...
const CookieConsent = () => {
  ...
  const translations = {
    en: {
      ...
      necessaryDesc: "These cookies are essential for the website to function properly. They enable basic features like page navigation and access to secure areas.",
    ...
    fr: {
      ...
      description: "Nous utilisons des cookies pour améliorer votre expérience de navigation, analyser le trafic du site et fournir du contenu personnalisé. En cliquant sur 'Tout accepter', vous consentez à notre utilisation des cookies.",
      ...
      necessaryDesc: "Ces cookies sont essentiels au bon fonctionnement du site web. Ils permettent les fonctions de base comme la navigation et l'accès aux zones sécurisées.",
      analyticsTitle: "Cookies d'analyse",
      analyticsDesc: "Ces cookies nous aident à comprendre comment les visiteurs interagissent avec notre site web en collectant et rapportant des informations de manière anonyme.",
